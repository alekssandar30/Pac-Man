...
class TournamentWindow(QWidget): # 800, 640
    ...
    def init_UI(self):
        ...
        self.pacman_icon1.move(225, 313)
        self.pacman_icon2 = QLabel(self)
        self.pacman_icon2.move(541, 313)
        ...
        if self.tournament_type == 8:
            ...
            self.field4_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field4_for_name.move(45, 502)
            self.field5_for_name.setText(self.player_names[4].capitalize())
            self.field5_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field5_for_name.move(682, 191)
            self.field6_for_name.setText(self.player_names[5].capitalize())
            self.field6_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field6_for_name.move(682, 323)
            self.field7_for_name.setText(self.player_names[6].capitalize())
            self.field7_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field7_for_name.move(682, 371)
            self.field8_for_name = QLabel(self.player_names[7].capitalize(), self)
            self.field8_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field8_for_name.move(682, 502)

            self.pacman_icon1.move(187, 256)
            self.field9_for_name = QLabel(self)
            self.field9_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field9_for_name.move(223,257)

            self.pacman_icon2.move(187, 436)
            self.field10_for_name = QLabel(self)
            self.field10_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field10_for_name.move(223,437)

            self.pacman_icon3.move(588, 256)
            self.field11_for_name = QLabel( self)
            self.field11_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field11_for_name.move(506, 257)

            self.pacman_icon4 = QLabel(self)
            self.pacman_icon4.move(586, 436)
            self.field12_for_name = QLabel(self)
            self.field12_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field12_for_name.move(506, 437)

            self.pacman_icon5 = QLabel(self) #345 26
            self.pacman_icon5.move(340, 324)
            self.field13_for_name = QLabel(self)
            self.field13_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field13_for_name.move(379, 324)

            self.pacman_icon6 = QLabel(self)
            self.pacman_icon6.move(433, 374)
            self.field14_for_name = QLabel(self)
            self.field14_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field14_for_name.move(355, 375)

            self.pacman_icon7 = QLabel(self)
            self.pacman_icon7.move(386, 531)
            self.field15_for_name = QLabel(self)
            self.field15_for_name.setStyleSheet("font: 10pt Comic Sans MS; color: white")
            self.field15_for_name.move(356, 466)
